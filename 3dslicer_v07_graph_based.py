"""Simplified adaptive centerline extraction with graph-based skeleton path (v07)
...
if __name__ == "__main__":
    ...
    p = argparse.ArgumentParser(
        description="Graph-based skeleton centerline extraction with optional island connection (v07)"
    )
