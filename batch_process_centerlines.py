...
def process_file(input_file: Path, output_json: Path) -> bool:
    ...
    try:
        ...
        print(f"Step 1: Extracting centerlines...")
        cmd1 = [
            sys.executable,
        ...
        if output_json.exists() and output_json.stat().st_size > 0:
            ...
            print(f"⚠️  JSON file is empty or missing")
            return False
