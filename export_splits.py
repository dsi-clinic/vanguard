...
Examples:
    ...
    python export_splits.py --excel metadata.xlsx --output splits.csv \
        --datasets iSpy2 Duke
    python export_splits.py --excel metadata.xlsx --output splits.csv \
        --config docs/eval_selection_example.yaml
"""
...
def export_splits(
    ...
    *,
    ...
    Thin CLI wrapper around evaluation.kfold.export_splits_to_csv().
