...
This directory contains outputs from Jose's extraction method, as mentioned in `pcr_prediction.py` model. It contains evaluation metrics, visualizations, and feature importance data by the pCR prediction pipeline.
