...
\begin{column}{\colwidth}
  ...
  \begin{exampleblock}{Results}
    ...
    \textbf{0.607 and 0.624} AUC, with heavily overlapping intervals. The paired
    difference between the best GNN and the best tabular baseline is consistent
    with zero, $+0.002$ $[-0.041, 0.046]$.
