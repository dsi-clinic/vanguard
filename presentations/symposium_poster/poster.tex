...
\logoright{%
  \begin{tabular}{@{}c@{}}
    \includegraphics[height=5.2cm]{logos/uw_madison_white.pdf} \\[1.8ex]
    \includegraphics[height=3.5cm]{logos/nvhs_wildcat.png}\hspace{2em}%
    \includegraphics[height=3.5cm]{logos/bca_seal.png}
  \end{tabular}%
}
