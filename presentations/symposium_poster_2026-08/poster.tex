...
\documentclass[16pt, margin=1in, innermargin=15mm,
...
\block{From scan to prediction}{
  ...
  \begin{minipage}[c]{0.47\linewidth}
    ...
    patient's vessel graph. Segmentation and centerline extraction are upstream
    lab pipeline --- this project starts at the graph.
  \end{minipage}
}
...
\block{Contrast-forecasting pretraining}{
  ...
  per-node forecaster, then random initialisation on pCR by more than twice the
  seed-to-seed spread.
...
\block{\badgeontitle{1}\ \ Signal in the vessels?\ \ \color{LightYellow}YES}{
  ...
  the enhancement features: pooled AUC $0.49 \rightarrow 0.61$.}
