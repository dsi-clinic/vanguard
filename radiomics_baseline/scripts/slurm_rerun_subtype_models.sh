...
#SBATCH --output=/home/summe/vanguard/radiomics_baseline/logs/subtype_models_%j.out
#SBATCH --error=/home/summe/vanguard/radiomics_baseline/logs/subtype_models_%j.err
